...
export default function Quantity({ productId, productStock, variation, quantity, updateCartItem }) {
  ...
  return (
    <div className="flex size-max rounded-sm border-1 border-pearl-bush">
      <button onClick={handleQuantityDecrease} className="h-12.5 w-7.5 cursor-pointer justify-items-center" aria-label="Decrease quantity">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-2 fill-boulder hover:fill-shark">
      ...
      />
      <button onClick={handleQuantityIncrease} className="h-12.5 w-7.5 cursor-pointer justify-items-center" aria-label="Increase quantity">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-2 fill-boulder hover:fill-shark">
