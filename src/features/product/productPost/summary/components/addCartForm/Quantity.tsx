  ...
  return (
    <div className="flex">
      <button
        ...
        className="h-12.5 w-12.5 cursor-pointer justify-items-center rounded-l-md bg-spring-wood transition-colors duration-300 ease-in-out hover:bg-pearl-bush"
        onClick={handleQuantityDecrease}
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-4 fill-boulder">
      ...
      <button
        ...
        className="h-12.5 w-12.5 cursor-pointer justify-items-center rounded-r-md bg-spring-wood transition-colors duration-300 ease-in-out hover:bg-pearl-bush"
